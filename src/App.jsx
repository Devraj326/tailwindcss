...
function App() {
  ...
  return (
    <>
      <nav className='flex items-center justify-between flex-wrap p-5 bg-blue-500'>
      ...
      <div>
        <button className="border rounded bg-green-500 text-xl text-white px-2 py-2 mx-20 my-5 mt-5">Button One</button>
      </div>
      ...
      <div className="max-w-max mx-auto flex justify-center bg-purple-300 shadow-lg ml-auto mt-1 rounded-lg p-4">
        <div>
